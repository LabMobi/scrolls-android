...
/**
 * Dummy implementation. Just for internal testing. Do not use.
 */
public class LogImplBofh extends Log {
    ...
    protected void debug(final String tag, String msg) {
        msg = getReason();
        System.out.println("BOFH/" + tag + " " + msg);
    }
    ...
    protected void warning(final String tag, String msg) {
        error(tag, msg);
    }
    ...
    protected void error(final String tag, String msg) {
        msg = getReason();
        System.err.println("BOFH/" + tag + " " + msg);
    }

    protected void error(final String tag, String msg, final Throwable t) {
        error(tag, msg);
    }

    protected void info(final String tag, String msg) {
        msg = getReason();
        System.out.println("BOFH/" + tag + " " + msg);
    }
